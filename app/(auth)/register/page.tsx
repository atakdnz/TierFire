          ...
          <div className="bg-[#1a1a1a] rounded-xl border border-[#262626] p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="relative">
                <Mail className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-[#525252]" />
                <Input
                  type="email"
                  placeholder="Email"
                  value={email}
              ...
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-[#525252]" />
                <Input
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-[#1a1a1a] text-[#525252]">or</span>
              </div>
            </div>
